...
const obj = Object.fromEntries(userProfiles)   //{commanderTom: 23, derekZlander: 40}
const profiles = Object.entries(obj) [['commanderTom', 23], ['derekZlander', 40]]

//#11
try{
 bob + 'hi'
} catch {  //In ES10 you don't need to say catch(error)
